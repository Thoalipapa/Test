	...
	public static void main(String[] args) {
		...
		new Auto("Ford",   125000, 7999.99, "silber metallic", false, "Diesel", 101.0);
		 ...
		 new Auto("Ford", 1700, 17999.99, "silber metallic", false, "Diesel", 101.0);
		  ...
		  System.out.println("Erlös ohne Nachlass: " + Math.round(100.0*Auto.erloes_inkl_nachlass(0, 0))/100.0 + " EUR");
		  System.out.println("Erlös mit Nachlass: " + Math.round(100.0*Auto.erloes_inkl_nachlass(0.1, 0.25))/100.0 + " EUR");
